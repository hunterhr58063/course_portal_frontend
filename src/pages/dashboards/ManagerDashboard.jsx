...
const AdminDashboard = () => {
    ...
    const isBaseDashboard = location.pathname === '/manager';
    ...
    const cards = [
        { title: 'Courses', count: stats?.coursesCount ?? '-', link: '/manager/courses', linkText: 'Manage Courses' },
        { title: 'Students', count: stats?.studentsCount ?? '-', link: '/manager/students', linkText: 'Manage Students' },
    ];
    const navLinks = [
